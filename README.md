...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/py-rust-stemmers-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/py-rust-stemmers-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add py-rust-stemmers
# for installing globally
pixi global install py-rust-stemmers
```
...
It is possible to list all of the versions of `py-rust-stemmers` available on your platform:
...
```
pixi search py-rust-stemmers --channel conda-forge
```
